...
CROSS JOIN lateral( VALUES 
       ('RR Interval',"ECGRR"::text , "ECGRR_Units" , "ECGRR_Units" , "ECGRR"::text ),
       ('HR',"ECGHR"::text , "ECGHR_Units" , "ECGHR_Units" , "ECGHR"::text ),
	   ('QT Interval',"ECGQT"::text , "ECGQT_Units" , "ECGQT_Units" , "ECGQT"::text ),
	   ('QTc Interval',"ECGQTC"::text , "ECGQTC_Units" , "ECGQTC_Units" , "ECGQTC"::text )
       ) AS t 
       (egscat,egorres, egorresu, egstresu, egstresn ))eg
     )
