...
WITH included_subjects AS (
	...
	normlab as(SELECT lb1."project"::text AS studyid,
						...
						CASE
							...
							WHEN lb1."DataPageName" like '%PSA Blood Sampling%' THEN max(psa."LBDAT")
			...
			LEFT JOIN tas3681_101."CHEM" chem on (lb1."project" = chem."project" AND lb1."SiteNumber"= chem."SiteNumber" AND lb1."Subject" = chem."Subject" AND lb1."InstanceName" = chem."InstanceName")
			LEFT JOIN tas3681_101."COAG" coag on (lb1."project" = coag."project" AND lb1."SiteNumber" = coag."SiteNumber" AND lb1."Subject" = coag."Subject" AND lb1."InstanceName" = coag."InstanceName")
			LEFT JOIN tas3681_101."HEMA" hem on (lb1."project" = hem."project" AND lb1."SiteNumber" = hem."SiteNumber" AND lb1."Subject" = hem."Subject" AND lb1."InstanceName" = hem."InstanceName")	
            LEFT JOIN tas3681_101."URIN" urin on (lb1."project" = urin."project" AND lb1."SiteNumber" = urin."SiteNumber" AND lb1."Subject" = urin."Subject" AND lb1."InstanceName" = urin."InstanceName")	
            	LEFT JOIN tas3681_101."PSA" psa on (lb1."project" = psa."project" AND lb1."SiteNumber" = psa."SiteNumber" AND lb1."Subject" = psa."Subject" AND lb1."InstanceName" = psa."InstanceName")			
     ...
     lb_data AS (
					...
					siteid,
					usubjid,
					regexp_replace(visit, '<WK[0-9]D[0-9]/>', ''):: text as visit,
                   	lbdtc,
					lbdy,
					--lbseq,
